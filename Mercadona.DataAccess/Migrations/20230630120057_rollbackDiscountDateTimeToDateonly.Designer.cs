...
namespace Mercadona.DataAccess.Migrations
{
    ...
    [Migration("20230630120057_rollbackDiscountDateTimeToDateonly")]
    partial class rollbackDiscountDateTimeToDateonly
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mercadona.Models.Discount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            DiscountValue = 25,
                            EndDate = new DateOnly(2023, 12, 26),
                            Name = "Christmas Discount",
                            StartDate = new DateOnly(2023, 12, 20)
                        },
                        new
                        {
                            Id = 2,
