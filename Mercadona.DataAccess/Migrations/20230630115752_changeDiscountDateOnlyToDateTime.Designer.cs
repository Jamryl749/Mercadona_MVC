...
namespace Mercadona.DataAccess.Migrations
{
    ...
    [Migration("20230630115752_changeDiscountDateOnlyToDateTime")]
    partial class changeDiscountDateOnlyToDateTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mercadona.Models.Discount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            DiscountValue = 25,
                            EndDate = new DateTime(2023, 12, 26, 23, 59, 59, 0, DateTimeKind.Utc),
                            Name = "Christmas Discount",
                            StartDate = new DateTime(2023, 12, 20, 0, 0, 1, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 2,
                            DiscountValue = 15,
                            EndDate = new DateTime(2024, 3, 1, 23, 59, 59, 0, DateTimeKind.Utc),
                            Name = "Winter Discount",
                            StartDate = new DateTime(2023, 12, 1, 0, 0, 1, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 3,
                            DiscountValue = 10,
                            EndDate = new DateTime(2023, 11, 30, 23, 59, 59, 0, DateTimeKind.Utc),
                            Name = "DIY Discount",
                            StartDate = new DateTime(2023, 6, 30, 0, 0, 1, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 4,
                            DiscountValue = 10,
                            EndDate = new DateTime(2023, 8, 31, 23, 59, 59, 0, DateTimeKind.Utc),
                            Name = "Summer Discount",
                            StartDate = new DateTime(2023, 7, 1, 0, 0, 1, 0, DateTimeKind.Utc)
                        });
                });
